            ...
            >
              ...
              >
                ...
                <button
                  ...
                  className={`flex-1 px-1 h-full rounded-full text-xs font-bold z-20 transition-all duration-300 cubic-bezier(0.16, 1, 0.3, 1) outline-none whitespace-nowrap flex items-center justify-center ${
