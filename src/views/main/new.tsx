    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-8 flex flex-col">
          ...
          {/* Полноценный премиальный Таббар (подобие шапки, потемнее) */}
          ...
          {/* Блок описания (иконка теперь без квадрата) */}
          <div className="flex items-start space-x-3 px-1 mb-6 min-h-[52px] select-none">
            <img 
              src={currentTab.icon} 
              alt={currentTab.label} 
              className="w-5 h-5 object-contain dark:brightness-0 dark:invert opacity-60 flex-shrink-0 mt-0.5"
            />
          ...
          {/* Форма ввода для обычной Оценки */}
          {activeSubTab === "rate" ? (
